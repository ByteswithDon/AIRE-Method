                  ...
                  {bioOpen && (
                    ...
                    >
                      <div className="pt-5 space-y-3 text-sm leading-relaxed font-medium" style={{ color: C.muted }}>
                        <p>I&rsquo;m curious about how systems work and how to explain them so the people using them actually understand. I use AI-enabled prototyping to model features before rollout, so technical and non-technical people can see and test a tool early, before anything goes live.</p>
                        <p>Today I architect and govern an internal LMS environment inside the Microsoft 365 stack (SharePoint, Teams, Learn 365), owning the information architecture, permissions, and documentation standards behind how staff learning and institutional knowledge are stored and accessed, while supporting usability and engagement research on a public Massive Open Online Course Product (MOOC) for educators. I also evaluate and onboard new products, weighing integration feasibility, governance alignment, and adoption risk.</p>
                        <p>My path runs from molecular cell biology and the science classroom to learning experience design and platform architecture, so I read both the technical system and the people who have to adopt it. Day to day I work across the M365 stack and a range of LMS platforms (Docebo, Canvas, Moodle, Learn 365), with lightweight backends in SQL, Supabase, Vercel, and GitHub.</p>
                        <div className="pt-3">
